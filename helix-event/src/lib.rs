...
//! that gets called evrytime an approriate event is dispatched. The implementation
//! details of the [`Event`] trait are considered private. The [`events`] macro is
//! provided which automatically declares event types. Similarly the `regist_hook`
...
macro_rules! register_hook {
    // Safety: this is save because we fully control the type of the event here and
